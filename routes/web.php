...
Route::middleware('guest')->group(function () {
    ...
    Route::get('check-pasword', [LoginController::class, 'checkpassword'])->name('check_pasword');
    Route::post('check-pasword', [LoginController::class, 'checkpasswordreset'])->name('check_pasword_reset');
    // login google
    Route::get('/login-google', [HomeController::class, 'getlogin'])->name('getlogin');
    Route::get('/auth/google/callback', [HomeController::class, 'logincallback']);
    // register
...
Route::middleware([CheckAccountLogin::class])->prefix('gio-hang')->group(function () {
    ...
    // check sản phẩm và điền thông tin vận chuyển
    Route::get('/check-order', [GiohangController::class, 'check'])->name('check_order');
    // form điền thông tin
    Route::post('/detail-order/user', [GiohangController::class, 'detail'])->name('detail_order');
    // view đơn hàng
